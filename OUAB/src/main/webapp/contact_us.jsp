...
<title>Contact-us Page| OUAB</title>
...
<form action="index.jsp" method="POST" class="contact" onsubmit ="confirmation(1)" onreset ="confirmation(2)">
...
<br><textarea placeholder="Write your massage..." onkeydown="changeBr(this, '#a79084')"></textarea>
...
<select required placeholder="Rate Our Site:" >
