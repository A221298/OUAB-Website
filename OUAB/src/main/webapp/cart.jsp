		...
		<tbody>
			...
			<tr>
				<td>
					...
					//Get Cart
					sqlQuery = "SELECT * FROM cart WHERE username = '" + username + "' ORDER BY bookid DESC LIMIT 1";
					preparedStmt = connection.prepareStatement(sqlQuery);
					result = preparedStmt.executeQuery();
					while (result.next()) {
					%>
						...
						<table class="tab_cart" style="display: table">
							...
							<tbody>
								<%
									...
									//Get Book Name
									sqlQuery = "SELECT name FROM books WHERE Bid = '" + bookID + "' ORDER BY Bid";
									preparedStmt = connection.prepareStatement(sqlQuery);
									result = preparedStmt.executeQuery();
									...
									//Get Book price
									sqlQuery = "SELECT price FROM books WHERE Bid = '" + bookID + "' ORDER BY Bid";
									preparedStmt = connection.prepareStatement(sqlQuery);
									result = preparedStmt.executeQuery();
									while (result.next()) {
